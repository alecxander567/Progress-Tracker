  ...
  const NEWS = [
    {
      ...
      description:
        "The Cybersecurity and Infrastructure Security Agency (CISA) enhances guidance for implementing Zero Trust principles across enterprise systems.",
      icon: "shield-alt",
    },
    {
      ...
      description:
        "MITRE updates the ATT&CK framework, refining adversary tactics and techniques used in real-world cyber threats.",
      icon: "sitemap",
    },
    {
      ...
      description:
        "The latest OWASP Top 10 lists the most critical web application security risks for 2025, helping developers and security teams mitigate threats.",
      icon: "bug",
    },
    {
      ...
      description:
        "NIST provides recommendations for transitioning cryptographic systems to resist quantum computing threats.",
      icon: "lock",
    },
    {
      ...
      description:
        "Security updates address critical vulnerabilities in Microsoft Exchange Server that could allow remote code execution.",
    ...
    },
    {
      ...
      description:
        "A breakdown of how cybercriminals are increasingly using Ransomware-as-a-Service to execute widespread attacks.",
      icon: "skull",
    },
    {
      ...
      description:
        "Analyze the strengths and use cases of leading Security Information and Event Management tools.",
      icon: "chart-line",
    },
    {
      ...
      description:
        "Explore security recommendations for protecting cloud workloads on Amazon Web Services.",
      icon: "cloud",
    },
    {
      ...
      description:
        "A critical Linux vulnerability could allow privilege escalation. Patch and mitigation instructions included.",
      icon: "terminal",
    },
    {
      ...
      description:
        "CISA provides an updated checklist for small and mid-sized organizations to improve their basic cybersecurity posture.",
      icon: "tasks",
    },
  ];
        ...
        >
          ...
          >
            <h3 className="d-flex align-items-center gap-2">
              <i className="fas fa-newspaper text-info"></i> Cybersecurity Tech
              News
            </h3>
          ...
          >
            <h3 className="d-flex align-items-center gap-2">
              <i className="fas fa-shield-alt text-info"></i> Cybersecurity
              Specialist Focus Breakdown
            </h3>
            ...
            <ul className="list-unstyled">
              {[
                ...
                {
                  tech: "Security Information and Event Management (SIEM)",
                  percentage: 85,
                },
                { tech: "Threat Hunting & Incident Response", percentage: 80 },
                {
                  tech: "Vulnerability Assessment & Penetration Testing",
                  percentage: 75,
                },
                ...
                {
                  tech: "Security Compliance (NIST, ISO 27001)",
                  percentage: 55,
                },
              ].map((item, index) => (
