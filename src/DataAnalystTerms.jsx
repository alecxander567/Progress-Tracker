  ...
  const terms = [
    {
      ...
      category: "Library",
      definition:
        "An open-source Python library for data manipulation and analysis, especially with tabular data.",
    ...
    },
    {
      ...
      category: "Library",
      definition:
        "A fundamental package for scientific computing with Python, providing support for arrays and mathematical operations.",
    ...
    },
    {
      ...
      category: "Process",
      definition:
        "The graphical representation of information and data using charts, plots, and graphs.",
    ...
    },
    {
      ...
      category: "Tool",
      definition:
        "A Microsoft business analytics tool that allows you to visualize data and share insights.",
    ...
    },
    {
      ...
      category: "Tool",
      definition:
        "A data visualization software used for converting raw data into an understandable format.",
    ...
    },
    {
      ...
      category: "Process",
      definition:
        "Extract, Transform, Load - a data pipeline process to extract data from sources, transform it, and load it into a destination system.",
    ...
    },
    {
      ...
      category: "Concept",
      definition:
        "A statistical method of comparing two versions of a variable to determine which performs better.",
    ...
    },
    {
      ...
      category: "Output",
      definition:
        "A visual display of key metrics and trends, typically used to monitor performance in real time.",
    ...
    },
    {
      ...
      category: "Process",
      definition:
        "The process of selecting, modifying, or creating new features to improve the performance of machine learning models.",
    ...
    },
    {
      ...
      category: "Concept",
      definition:
        "A field of AI that enables systems to learn patterns from data and make predictions.",
    ...
    },
    {
      ...
      category: "Concept",
      definition:
        "Data that is freely available to everyone to use, reuse, and redistribute.",
          ...
          <div className="row mb-3 mb-md-4">
            <div className="col-12">
              <p className="lead mb-3 mb-md-4 fs-6 fs-md-5">
                Master the essential vocabulary of Data Analyst
              </p>
