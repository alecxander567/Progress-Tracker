  ...
  const terms = [
    {
      ...
      category: "Markup",
      definition:
        "HyperText Markup Language - the foundation for structuring web content.",
    ...
    },
    {
      ...
      category: "Styling",
      definition:
        "Cascading Style Sheets - controls the layout and design of web pages.",
    ...
    },
    {
      ...
      definition:
        "A scripting language that adds interactivity and logic to web applications.",
    ...
    },
    {
      ...
      definition:
        "A JavaScript library for building dynamic user interfaces using components.",
    ...
    },
    {
      ...
      definition:
        "A minimal Node.js web application framework used for building APIs and web servers.",
    ...
    },
    {
      ...
      category: "Database",
      definition:
        "An ODM library for MongoDB that provides schema-based modeling for your data.",
    ...
    },
    {
      ...
      category: "Security",
      definition:
        "JSON Web Token - a compact, URL-safe token used for secure data transmission and authentication.",
    ...
    },
    {
      ...
      category: "Concepts",
      definition:
        "The structure of a database, including tables, fields, and relationships.",
    ...
    },
    {
      ...
      category: "Tools",
      definition:
        "Version control system for tracking code changes collaboratively.",
    ...
    },
    {
      ...
      category: "Tools",
      definition:
        "Node Package Manager - manages JavaScript libraries and tools for your projects.",
    ...
    },
    {
      ...
      category: "Tools",
      definition:
        "A tool for bundling JavaScript modules and assets for efficient browser delivery.",
          ...
          <div className="row mb-3 mb-md-4">
            <div className="col-12">
              <p className="lead mb-3 mb-md-4 fs-6 fs-md-5">
                Master the essential vocabulary of full-stack development
              </p>
