              ...
              >
                ...
                <main className="flex-grow-1 p-3" style={{ zIndex: 1 }}>
                    ...
                    {[
                        ...
                        description: "Master basic to advanced Linux commands essential for server and infrastructure management.",
                        ...
                        description: "Learn version control using Git and how to collaborate with GitHub effectively.",
                        ...
                        description: "Get started with Docker to build, ship, and run applications in containers.",
                        ...
                        description: "Learn Kubernetes fundamentals for container orchestration and management.",
                        ...
                        description: "Set up a complete Jenkins CI/CD pipeline to automate testing and deployment.",
