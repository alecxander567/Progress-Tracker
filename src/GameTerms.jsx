  ...
  const terms = [
    {
      ...
      definition:
        "A powerful cross-platform game engine used to build 2D, 3D, VR, and AR games.",
    ...
    },
    {
      ...
      category: "Game Engine",
      definition:
        "A high-performance game engine known for realistic graphics and used widely in AAA games.",
    ...
    },
    {
      ...
      definition:
        "The primary language used in Unity for scripting gameplay mechanics and logic.",
    ...
    },
    {
      ...
      definition:
        "A visual scripting system in Unreal Engine that lets developers create gameplay without writing code.",
    ...
    },
    {
      ...
      category: "Programming Language",
      definition:
        "A Python-like language used to script game logic in Godot Engine.",
    ...
    },
    {
      ...
      category: "Concepts",
      definition:
        "A core programming pattern in games that handles rendering and updates on every frame.",
    ...
    },
    {
      ...
      category: "Physics",
      definition:
        "A component that allows game objects to react to physics forces and collisions.",
    ...
    },
    {
      ...
      category: "Animation",
      definition:
        "A system in Unity that manages character animations using states and transitions.",
    ...
    },
    {
      ...
      category: "AI",
      definition:
        "A navigation mesh used for AI pathfinding within game environments.",
    ...
    },
    {
      ...
      category: "Physics",
      definition:
        "A technique used to detect objects along a straight line, often for shooting or interaction.",
    ...
    },
    {
      ...
      category: "Tools",
      definition:
        "A reusable game object template in Unity that can be instantiated multiple times.",
    ...
    },
    {
      ...
      definition:
        "A grid-based system for building 2D game levels using tiles.",
    ...
    },
    {
      ...
      category: "Tools",
      definition:
        "A level or section of a game containing objects, environments, and logic.",
    ...
    },
    {
      ...
      category: "Graphics",
      definition:
        "A program that controls how graphics are rendered on the screen.",
    ...
    },
    {
      ...
      category: "Tools",
      definition:
        "The process of packaging your game project into a playable application.",
    ...
    },
    {
      ...
      category: "Concepts",
      definition:
        "The system that simulates physical interactions in the game world.",
    ...
    },
    {
      ...
      category: "Tools",
      definition:
        "A system that handles player input from keyboard, mouse, or controller.",
    ...
    },
    {
      ...
      definition:
        "Used in Unity to run asynchronous tasks like timed actions or delays.",
          ...
          <div className="row mb-3 mb-md-4">
            <div className="col-12">
              <p className="lead mb-3 mb-md-4 fs-6 fs-md-5">
                Master the essential vocabulary of Game development
              </p>
