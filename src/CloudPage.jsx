  ...
  const NEWS = [
    {
      ...
      description:
        "Amazon EC2 now offers Graviton4-based instances, delivering better performance and cost-efficiency.",
      icon: "server",
    },
    {
      ...
      description:
        "Google Cloud expands Vertex AI capabilities to help engineers build and deploy models faster.",
      icon: "robot",
    },
    {
      ...
      description:
        "Microsoft Azure adds confidential VMs to enhance workload security for cloud environments.",
      icon: "lock",
    },
    {
      ...
      description:
        "Terraform’s latest release introduces better resource targeting and module dependency tracking.",
      icon: "cogs",
    },
    {
      ...
      description:
        "Learn strategies and design patterns for managing infrastructure across multiple cloud providers.",
    ...
    },
    {
      ...
      description:
        "The latest version of Kubernetes improves batch job performance and cluster stability.",
      icon: "cubes",
    },
    {
      ...
      description:
        "A guide to implementing secure access control using AWS Identity and Access Management.",
      icon: "key",
    },
    {
      ...
      description:
        "Explore the evolution of serverless computing and how cloud engineers can leverage it.",
      icon: "cloud",
    },
    {
      ...
      description:
        "Compare key features and use cases for Prometheus and AWS CloudWatch.",
      icon: "chart-line",
    },
    {
      ...
      description:
        "Explore how Zero Trust principles enhance security for cloud-based systems.",
      icon: "shield-alt",
    },
  ];
    ...
    >
      ...
      <main className="flex-grow-1 p-3" style={{ zIndex: 1 }}>
        ...
        >
          ...
          >
            <h3 className="d-flex align-items-center gap-2">
              <i className="fas fa-cloud text-info"></i> Cloud Engineer Focus
              Breakdown
            </h3>
            ...
            <ul className="list-unstyled">
              {[
                ...
                {
                  tech: "Serverless (AWS Lambda, Azure Functions)",
                  percentage: 65,
                },
