...
function DataAnalystPage() {
  ...
  const NEWS = [
  {
    ...
    description: 'Explore the leading tools used by data analysts today including Python, R, and Power BI.',
    icon: 'chart-bar',
  },
  {
    title: 'Mastering SQL for Data Analysis',
    url: 'https://mode.com/sql-tutorial/',
    description: 'Learn how SQL is used to query, analyze, and manage large datasets effectively.',
    icon: 'database',
  },
  {
    title: 'Pandas 3.0: What’s New?',
    url: 'https://pandas.pydata.org/whatsnew/',
    description: 'The latest version of Pandas introduces performance boosts and simplified data transformations.',
    icon: 'code',
  },
  {
    title: 'Data Cleaning Techniques Every Analyst Should Know',
    url: 'https://www.kaggle.com/learn/data-cleaning',
    description: 'Get practical with techniques to clean and prepare messy datasets.',
    icon: 'broom',
  },
  {
    title: 'Excel Power Query: Automate Your Data Workflow',
    url: 'https://support.microsoft.com/en-us/excel-power-query',
    description: 'Power Query lets you automate and transform your data directly in Excel.',
    icon: 'table',
  },
  {
    title: 'Visualizing Data with Tableau: A Beginner’s Guide',
    url: 'https://www.tableau.com/learn/get-started',
    description: 'An introduction to building interactive dashboards with Tableau.',
    icon: 'chart-pie',
  },
  {
    ...
    description: 'A comparison of two of the most popular languages in data analysis.',
    icon: 'balance-scale',
  },
  {
    title: 'Data Storytelling: Turning Insights into Action',
    url: 'https://www.linkedin.com/pulse/data-storytelling-key-skill-analyst/',
    description: 'Learn how to present your findings effectively with clear narratives and visuals.',
    icon: 'book-open',
  },
  {
    ...
    description: 'Understand how artificial intelligence is changing the landscape of data analytics.',
    icon: 'robot',
  },
  {
    title: 'Ethics in Data: What Every Analyst Must Know',
    url: 'https://hbr.org/2020/01/what-you-need-to-know-about-data-ethics',
    description: 'A look at ethical responsibilities when working with user and organizational data.',
    icon: 'shield-alt',
  },
];
        ...
        >
          ...
          >
            <h3 className="d-flex align-items-center gap-2">
              <i className="fas fa-newspaper text-info"></i> Data Analyst Tech News
            </h3>
...
>
  <h3 className="d-flex align-items-center gap-2">
    <i className="fas fa-chart-bar text-info"></i> Data Analyst Skills Breakdown
  </h3>
  ...
  <ul className="list-unstyled">
    {[
      ...
      { tech: "Data Visualization (Tableau/Power BI)", percentage: 75 },
