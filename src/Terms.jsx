...
function Terms() {
  ...
  const terms = [
    ...
    },
    {
      ...
      category: "Styling",
      definition:
        "Cascading Style Sheets - used to describe the presentation of a document written in HTML or XML.",
    ...
    },
    {
      ...
      definition:
        "A high-level, interpreted programming language that enables interactive web pages and dynamic content.",
    ...
    },
    {
      ...
      category: "Concepts",
      definition:
        "Document Object Model - a programming interface for HTML and XML documents representing the page structure.",
    ...
    },
    {
      ...
      category: "Framework",
      definition:
        "A popular CSS framework for developing responsive and mobile-first websites quickly.",
    ...
    },
    {
      ...
      category: "Styling",
      definition:
        "A CSS layout method for arranging items in rows or columns with flexible sizing and alignment.",
    ...
    },
    {
      ...
      category: "Programming",
      definition:
        "Asynchronous JavaScript and XML - technique for creating fast, dynamic web pages without page reloads.",
    ...
    },
    {
      ...
      category: "Concepts",
      definition:
        "Single Page Application - a web app that loads a single HTML page and dynamically updates content.",
    ...
    },
    {
      ...
      category: "Concepts",
      definition:
        "Progressive Web App - web applications that use modern web capabilities to deliver app-like experiences.",
    ...
    },
    {
      ...
      category: "Tools",
      definition:
        "A static module bundler for JavaScript applications that bundles modules and assets.",
    ...
    },
    {
      ...
      category: "Tools",
      definition:
        "Node Package Manager - the default package manager for Node.js, used to install and manage dependencies.",
    ...
    },
    {
      ...
      category: "Styling",
      definition:
        "Syntactically Awesome Style Sheets - a CSS preprocessor that adds features like variables and nesting.",
          ...
          <div className="row mb-3 mb-md-4">
            <div className="col-12">
              <p className="lead mb-3 mb-md-4 fs-6 fs-md-5">
                Master the essential vocabulary of front-end development
              </p>
