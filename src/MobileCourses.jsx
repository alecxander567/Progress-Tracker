        ...
        <div className="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
          {[
            ...
            },
            {
              ...
              description:
                "Create cross-platform apps using React Native and JavaScript.",
            ...
            },
            {
              title: "Swift for iOS",
              description:
                "Learn Swift to create powerful apps for iPhone and iPad.",
            ...
            },
            {
              ...
              description:
                "Handle authentication, database, and hosting with Firebase.",
            ...
            },
            {
              ...
              description:
                "Use Git and GitHub to track and collaborate on mobile projects.",
