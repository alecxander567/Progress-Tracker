  ...
  const NEWS = [
    {
      ...
      description:
        "PyTorch 2.2 brings compiler enhancements and improved support for dynamic shapes.",
      icon: "python",
    },
    {
      ...
      description:
        "The latest TensorFlow version focuses on Keras usability and model deployment optimization.",
      icon: "cogs",
    },
    {
      ...
      description:
        "Scikit-learn adds new models, improved outlier detection, and faster training routines.",
      icon: "chart-line",
    },
    {
      ...
      description:
        "Hugging Face expands the Transformers library to include powerful image classification models.",
      icon: "robot",
    },
    {
      ...
      description:
        "Vertex AI simplifies model training, deployment, and monitoring on Google Cloud.",
      icon: "cloud",
    },
    {
      ...
      description:
        "NVIDIA NeMo provides large language model training and speech recognition tools.",
      icon: "microchip",
    },
    {
      ...
      description:
        "A guide to interpretability techniques for machine learning models.",
      icon: "eye",
    },
    {
      ...
      description:
        "Learn how to efficiently fine-tune large models using parameter-efficient methods.",
      icon: "flask",
    },
    {
      ...
      description:
        "MLflow now includes native support for model evaluation and improved UI.",
      icon: "beaker",
    },
    {
      ...
      description:
        "ONNX Runtime offers cross-platform high-performance model inference capabilities.",
      icon: "laptop-code",
    },
  ];
          ...
          >
            ...
            <ul className="list-unstyled">
              {[
                ...
                {
                  tech: "Data Visualization (Matplotlib, Seaborn)",
                  percentage: 60,
                },
