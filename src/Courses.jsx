  ...
  return (
    ...
    >
      ...
      <div className="container position-relative z-1 py-5">
        ...
        <p className="mb-4">
          Pick your career path. Watch and learn. Build your project
        </p>
        <div className="row">
          <div className="col-md-6 mb-4">
            <div className="p-4 bg-dark rounded shadow">
              ...
              <ul className="list-unstyled">
                <li>
                  <Link to="/FrontEndPage" className="course-link">
                    🔹 Front-End Development
                  </Link>
                </li>
                <li>
                  <Link to="/BackEndPage" className="course-link">
                    🔹 Back-End Development
                  </Link>
                </li>
                <li>
                  <Link to="/FullStackPage" className="course-link">
                    🔹 Full-Stack Development
                  </Link>
                </li>
                <li>
                  <Link to="/MobilePage" className="course-link">
                    🔹 Mobile App Development
                  </Link>
                </li>
                <li>
                  <Link to="/GamePage" className="course-link">
                    🔹 Game Development
                  </Link>
                </li>
              </ul>
          ...
          <div className="col-md-6 mb-4">
            <div className="p-4 bg-dark rounded shadow">
              ...
              <ul className="list-unstyled">
                <li>
                  <Link to="/DataAnalystPage" className="course-link">
                    🔹 Data Analyst
                  </Link>
                </li>
                <li>
                  <Link to="/CloudPage" className="course-link">
                    🔹 Cloud Engineer
                  </Link>
                </li>
                <li>
                  <Link to="/DevOpsPage" className="course-link">
                    🔹 DevOps Engineer
                  </Link>
                </li>
                <li>
                  <Link to="/CyberSecurityPage" className="course-link">
                    🔹 Cybersecurity Specialist
                  </Link>
                </li>
                <li>
                  <Link to="/AIMLPage" className="course-link">
                    🔹 AI/ML Engineer
                  </Link>
                </li>
              </ul>
