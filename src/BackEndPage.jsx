...
function BackEndPage() {
  ...
  },
  {
    ...
    description: 'Explore strategies to secure your back-end APIs against abuse.',
    icon: 'shield-alt',
  },
  {
    title: 'Exploring Serverless Back-End with AWS Lambda',
    url: 'https://aws.amazon.com/lambda/',
    description: 'Learn how to build scalable serverless applications with AWS Lambda.',
    icon: 'cloud',
  },
];
    ...
    >
      <aside
        ...
        >
                ...
                <div className="col">
                    ...
                    >
                        ...
                        <div className="tech-icons">
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nodejs/nodejs-original.svg" className="tech-icon" style={{ position: 'absolute', top: '10%', left: '15%', width: '30px' }} alt="Node.js" />
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/express/express-original.svg" className="tech-icon" style={{ position: 'absolute', top: '40%', left: '70%', width: '30px' }} alt="Express" />
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mongodb/mongodb-original.svg" className="tech-icon" style={{ position: 'absolute', top: '70%', left: '25%', width: '30px' }} alt="MongoDB" />
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mysql/mysql-original.svg" className="tech-icon" style={{ position: 'absolute', top: '20%', left: '80%', width: '30px' }} alt="MySQL" />
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/postgresql/postgresql-original.svg" className="tech-icon" style={{ position: 'absolute', top: '30%', left: '40%', width: '30px' }} alt="PostgreSQL" />
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-original.svg" className="tech-icon" style={{ position: 'absolute', top: '60%', left: '55%', width: '30px' }} alt="Python" />
            ...
            >
                <h3 className="d-flex align-items-center gap-2">
                    <i className="fas fa-server text-info"></i> Back-End Focus Breakdown
                </h3>
