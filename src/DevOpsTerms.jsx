  ...
  const terms = [
    {
      ...
      category: "Tool",
      definition:
        "An open-source platform that enables developers to package applications into containers for consistent deployment across environments.",
    ...
    },
    {
      ...
      category: "Process",
      definition:
        "Continuous Integration and Continuous Deployment - automating the build, test, and deployment phases of application development.",
    ...
    },
    {
      ...
      category: "Tool",
      definition:
        "An automation tool used for configuration management, application deployment, and task automation.",
    ...
    },
    {
      ...
      category: "Tool",
      definition:
        "An open-source monitoring and alerting toolkit used for recording metrics and generating alerts.",
    ...
    },
    {
      ...
      category: "Tool",
      definition:
        "An open-source analytics and monitoring platform for visualizing time series data from various sources like Prometheus.",
    ...
    },
    {
      ...
      category: "Tool",
      definition:
        "An open-source automation server used to build, test, and deploy applications.",
    ...
    },
    {
      ...
      category: "Concept",
      definition:
        "A DevOps practice that uses Git as the source of truth for infrastructure and application deployments.",
    ...
    },
    {
      ...
      category: "Language",
      definition:
        "A script written for the shell (command line interpreter) used to automate tasks on Unix-like systems.",
      example: "./deploy.sh",
    },
    {
      term: "Monitoring",
      category: "Process",
      definition:
        "The practice of continuously observing systems and applications to track their performance and availability.",
    ...
    },
    {
      ...
      category: "Process",
      definition:
        "The process of collecting and storing logs to help with debugging and monitoring system health.",
    ...
    },
    {
      ...
      category: "Concept",
      definition:
        "A company that offers cloud computing services like infrastructure, platforms, and software.",
    ...
    },
    {
      ...
      category: "Language",
      definition:
        "A human-readable data serialization format commonly used for configuration files in DevOps tools.",
      example: "version: '3'\nservices:\n  app:\n    image: my-app",
    },
    {
      ...
      category: "Concept",
      definition:
        "The practice of securely storing, accessing, and managing sensitive data such as API keys and passwords.",
    ...
    },
    {
      ...
      category: "Process",
      definition:
        "Reverting an application or system to a previous stable state after a failed deployment or update.",
          ...
          <div className="row mb-3 mb-md-4">
            <div className="col-12">
              <p className="lead mb-3 mb-md-4 fs-6 fs-md-5">
                Master the essential vocabulary of DevOps Engineer
              </p>
