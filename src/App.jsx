  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path='/CyberSecurityCourses' element={<CyberSecurityCourses />} />
        ...
        <Route path='/DevOpsIdeas' element={<DevOpsIdeas></DevOpsIdeas>}></Route>
        <Route path='/CyberSecurityIdeas' element={<CyberSecurityIdeas></CyberSecurityIdeas>}></Route>
        ...
        <Route path='/DevopsTerms' element={<DevOpsTerms></DevOpsTerms>}></Route>
        <Route path='/CyberSecurityTerms' element={<CyberSecurityTerms></CyberSecurityTerms>}></Route>
        ...
        <Route path='/GameSettings' element={<GameSettings></GameSettings>}></Route>
        <Route path='/CloudSettings' element={<CloudSettings></CloudSettings>}></Route>
        <Route path='/DevOpsSettings' element={<DevOpsSettings></DevOpsSettings>}></Route>
        <Route path='/CyberSecuritySettings' element={<CyberSecuritySettings></CyberSecuritySettings>}></Route>
        <Route path='/AIMLSettings' element={<AIMLSettings></AIMLSettings>}></Route>
      </Routes>
    </Router>
  )
}
