  ...
  const NEWS = [
    {
      ...
      description:
        "Flutter 3.22 brings performance improvements, new widgets, and enhanced DevTools.",
      icon: "mobile-alt",
    },
    {
      ...
      description:
        "Improved performance, simplified architecture, and better iOS/Android support.",
      icon: "react",
    },
    {
      ...
      description:
        "Write shared code for Android and iOS using Kotlin Multiplatform Mobile (KMM).",
      icon: "code",
    },
    {
      ...
      description:
        "New APIs, performance gains, and improved tooling for modern Android UI.",
      icon: "android",
    },
    {
      ...
      description:
        "Apple adds powerful layout tools and improved navigation features in SwiftUI.",
      icon: "apple",
    },
    {
      ...
      description:
        "Firebase introduces new ML Kit and GenAI features for mobile developers.",
      icon: "fire",
    },
    {
      ...
      description:
        "New modules, bug fixes, and support for the latest React Native version.",
      icon: "cubes",
    },
    {
      ...
      description:
        ".NET MAUI lets you build native mobile apps using C# and XAML.",
      icon: "microsoft",
    },
    {
      ...
      description:
        "Make your mobile apps more inclusive with accessibility guidelines.",
    ...
    },
    {
      ...
      description:
        "Explore upcoming trends in mobile UI/UX design for the next generation of apps.",
      icon: "paint-brush",
    },
  ];
        ...
        >
          ...
          >
            <h3 className="d-flex align-items-center gap-2">
              <i className="fas fa-newspaper text-info"></i> Mobile App
              Development Tech News
            </h3>
            <p>
          ...
          >
            <h3 className="d-flex align-items-center gap-2">
              <i className="fas fa-mobile-alt text-info"></i> Mobile App Focus
              Breakdown
            </h3>
            ...
            <ul className="list-unstyled">
              {[
                ...
                {
                  tech: "State Management (e.g., Provider, Redux)",
                  percentage: 55,
                },
