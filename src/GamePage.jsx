...
function GamePage() {
  ...
  const NEWS = [
  {
    title: 'Unity 2025 LTS Released: Major Improvements to Performance and UI Tools',
    url: 'https://unity.com/releases/editor/whats-new/2025-lts',
    description: 'Unity’s 2025 LTS brings better rendering, faster workflows, and improved UI Toolkit for game devs.',
    icon: 'gamepad',
  },
  {
    ...
    description: 'New features in UE5.4 enhance real-time global illumination and virtualized geometry.',
    icon: 'cubes',
  },
  {
    title: 'Godot Engine 4.3: The Open Source Challenger Keeps Growing',
    url: 'https://godotengine.org/article/godot-4-3-release/',
    description: 'Godot’s latest version includes Vulkan updates, better 3D tools, and multiplayer support.',
    icon: 'cube',
  },
  {
    title: 'Blender for Game Dev: New Game Asset Tools in Version 4.0',
    url: 'https://www.blender.org/download/releases/4-0/',
    description: 'Blender 4.0 introduces new asset manager tools and improved texture baking for game artists.',
    icon: 'paint-brush',
  },
  {
    ...
    description: 'A beginner-friendly roundup of popular game engines and what makes each one unique.',
    icon: 'star',
  },
  {
    title: 'From Indie to AAA: Game Publishing Trends to Watch',
    url: 'https://gamasutra.com/article/indie-to-aaa-trends',
    description: 'Explore how indie developers are breaking into the mainstream and what AAA studios are adopting from them.',
    icon: 'chart-line',
  },
  {
    ...
    description: 'A guide to building online multiplayer games using WebSockets, Netcode, and more.',
    icon: 'users',
  },
  {
    ...
    description: 'An in-depth look at modern monetization models for mobile and PC game developers.',
    icon: 'dollar-sign',
  },
  {
    ...
    description: 'Learn how AI is changing the way developers build intelligent and immersive game worlds.',
    icon: 'robot',
  },
  {
    title: 'Optimizing Game Performance for Mobile Devices',
    url: 'https://developer.android.com/games/performance',
    description: 'Techniques for ensuring smooth framerate and battery efficiency in mobile games.',
    icon: 'mobile-alt',
  },
];
  ...
  <div className="col">
    ...
    >
      ...
      <div className="tech-icons">
        <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/unity/unity-original.svg" className="tech-icon" style={{ position: 'absolute', top: '10%', left: '15%', width: '30px' }} alt="Unity" />
        <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/unrealengine/unrealengine-original.svg" className="tech-icon" style={{ position: 'absolute', top: '40%', left: '70%', width: '30px' }} alt="Unreal Engine" />
        <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/blender/blender-original.svg" className="tech-icon" style={{ position: 'absolute', top: '70%', left: '25%', width: '30px' }} alt="Blender" />
        <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/godot/godot-original.svg" className="tech-icon" style={{ position: 'absolute', top: '20%', left: '80%', width: '30px' }} alt="Godot" />
        <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/csharp/csharp-original.svg" className="tech-icon" style={{ position: 'absolute', top: '30%', left: '40%', width: '30px' }} alt="C#" />
        <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/cplusplus/cplusplus-original.svg" className="tech-icon" style={{ position: 'absolute', top: '60%', left: '55%', width: '30px' }} alt="C++" />
        <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-original.svg" className="tech-icon" style={{ position: 'absolute', top: '50%', left: '10%', width: '30px' }} alt="Python" />
        ...
        <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/visualstudio/visualstudio-plain.svg" className="tech-icon" style={{ position: 'absolute', top: '75%', left: '65%', width: '30px' }} alt="Visual Studio" />
        </div>
      </div>
      </div>
      </div>
        ...
        >
          ...
          >
            <h3 className="d-flex align-items-center gap-2">
              <i className="fas fa-newspaper text-info"></i> Game Development Tech News
            </h3>
        ...
        >
            <h3 className="d-flex align-items-center gap-2">
                <i className="fas fa-gamepad text-info"></i> Game Development Focus Breakdown
            </h3>
