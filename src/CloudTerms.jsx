  ...
  const terms = [
    {
      ...
      category: "Compute",
      definition:
        "Amazon Elastic Compute Cloud provides scalable virtual servers in the cloud.",
    ...
    },
    {
      ...
      definition:
        "An open-source tool to define and provision infrastructure using declarative configuration files.",
    ...
    },
    {
      ...
      category: "Containers",
      definition:
        "A platform to package applications and their dependencies into containers for consistent deployment.",
    ...
    },
    {
      ...
      category: "Storage",
      definition:
        "Amazon Simple Storage Service offers scalable object storage with high availability.",
    ...
    },
    {
      ...
      category: "Networking",
      definition:
        "Virtual Private Cloud allows you to provision a logically isolated section of the cloud.",
    ...
    },
    {
      ...
      category: "Automation",
      definition:
        "An open-source tool for automating cloud provisioning, configuration management, and application deployment.",
    ...
    },
    {
      ...
      category: "CI/CD",
      definition:
        "A set of development tools to support continuous integration and delivery pipelines.",
    ...
    },
    {
      ...
      category: "Infrastructure as Code",
      definition:
        "AWS service to model and provision resources using templates written in JSON or YAML.",
    ...
    },
    {
      ...
      category: "Networking",
      definition:
        "A load balancing service that distributes incoming traffic across multiple targets.",
    ...
    },
    {
      ...
      category: "Deployment",
      definition:
        "A methodology using Git repositories as the source of truth for declarative infrastructure and applications.",
    ...
    },
    {
      ...
      category: "Security",
      definition:
        "AWS service that logs and monitors account activity and API usage for governance and compliance.",
    ...
    },
    {
      ...
      category: "Serverless",
      definition:
        "A framework for building and deploying serverless applications across cloud providers.",
          ...
          <div className="row mb-3 mb-md-4">
            <div className="col-12">
              <p className="lead mb-3 mb-md-4 fs-6 fs-md-5">
                Master the essential vocabulary of Coud Engineering
              </p>
