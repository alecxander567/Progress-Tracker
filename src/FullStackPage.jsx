  ...
  const NEWS = [
    {
      ...
      description:
        "Node.js 22 improves startup time, adds web platform APIs, and enhances fetch support.",
      icon: "node-js",
    },
    {
      ...
      description:
        "A detailed comparison of two leading full stack frameworks in modern web development.",
      icon: "layer-group",
    },
    {
      ...
      description:
        "MongoDB’s new feature aims to support AI and full stack applications requiring semantic search.",
      icon: "database",
    },
    {
      ...
      description:
        "tRPC allows typesafe APIs without needing a schema, ideal for TypeScript-based stacks.",
      icon: "exchange-alt",
    },
    {
      title:
        "The Rise of Bun: A JavaScript Runtime That’s Fast and Full Stack Friendly",
      url: "https://bun.sh/blog/bun-v1.0",
      description:
        "Bun promises better performance than Node.js and integrates deeply with full stack workflows.",
      icon: "rocket",
    },
    {
      ...
      description:
        "Learn how containerization and orchestration streamline full stack app deployment.",
      icon: "docker",
    },
    {
      ...
      description:
        "A comprehensive guide to managing secure and scalable user authentication.",
      icon: "user-lock",
    },
    {
      title:
        "Supabase vs Firebase: Which One is Better for Full Stack Projects?",
      url: "https://supabase.com/blog/supabase-vs-firebase",
      description:
        "A breakdown of key features and use cases for each backend-as-a-service platform.",
      icon: "fire",
    },
    {
      ...
      description:
        "Comparing two popular platforms for hosting full stack Jamstack and serverless applications.",
      icon: "cloud",
    },
    {
      ...
      description:
        "Explore the architecture patterns behind scalable, modular full stack systems.",
      icon: "cogs",
    },
  ];
        ...
        >
          ...
          >
            <h3 className="d-flex align-items-center gap-2">
              <i className="fas fa-newspaper text-info"></i> Full-Stack Tech
              News
            </h3>
            <p>
          ...
          >
            <h3 className="d-flex align-items-center gap-2">
              <i className="fas fa-layer-group text-info"></i> Full Stack Focus
              Breakdown
            </h3>
            ...
            <ul className="list-unstyled">
              {[
                ...
                {
                  tech: "Deployment (Netlify, Vercel, Heroku)",
                  percentage: 50,
                },
              ].map((item, index) => (
