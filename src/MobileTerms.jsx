...
function MobileTerms() {
   ...
   const terms = [
  {
    term: "React Native",
    category: "Framework",
    definition: "A popular JavaScript framework for building cross-platform mobile apps using native components.",
    example: "useState, View, Text"
  },
  {
    term: "Flutter",
    category: "Framework",
    definition: "A UI toolkit by Google for building natively compiled applications for mobile, web, and desktop from a single codebase.",
    example: "Widget, Scaffold, MaterialApp"
  },
  {
    term: "Dart",
    category: "Programming",
    definition: "The programming language used to build Flutter applications. It's optimized for UI and fast performance.",
    example: "void main() => runApp(MyApp());"
  },
  {
    term: "Kotlin",
    category: "Programming",
    definition: "A modern, expressive programming language used for Android app development, fully interoperable with Java.",
    example: "fun main() { println(\"Hello\") }"
  },
  {
    term: "Swift",
    category: "Programming",
    definition: "Apple's powerful and intuitive programming language for iOS, macOS, watchOS, and tvOS app development.",
    example: "let name = \"iOS\""
  },
  {
    term: "Android Studio",
    category: "Tools",
    definition: "The official IDE for Android development with tools for building, testing, and debugging Android apps.",
    example: "Logcat, AVD, Gradle"
  },
  {
    term: "Xcode",
    category: "Tools",
    definition: "Apple’s IDE for developing apps on iOS and macOS, includes interface builder, simulators, and more.",
    example: "Storyboard, SwiftUI Preview"
  },
  {
    term: "Expo",
    category: "Tools",
    definition: "A platform for building React Native apps with managed workflows and easy deployment/testing.",
    example: "expo start, expo build"
  },
  {
    term: "Firebase",
    category: "Tools",
    definition: "A mobile and web application development platform with services like authentication, database, and hosting.",
    example: "Firebase Auth, Firestore"
  },
  {
    term: "UI Widgets",
    category: "Concepts",
    definition: "Building blocks of user interfaces in Flutter and React Native, representing structural or functional elements.",
    example: "Button, ListView, TextInput"
  },
  {
    term: "State Management",
    category: "Concepts",
    definition: "The process of managing the state of an app, especially with complex UIs and multiple interactions.",
    example: "useState, Provider, Bloc"
  },
  {
    term: "Hot Reload",
    category: "Tools",
    definition: "A development feature allowing instant code updates to reflect changes without losing state.",
  ...
  },
  {
    term: "AsyncStorage",
    category: "Data",
    definition: "A simple, asynchronous, persistent, key-value storage system for React Native apps.",
    example: "AsyncStorage.setItem(), getItem()"
  },
  {
    term: "SharedPreferences",
    category: "Data",
    definition: "A way to store key-value pairs in Android apps for lightweight persistent storage.",
    example: "prefs.getString(\"user\")"
  },
  {
    term: "App Permissions",
    category: "Concepts",
    definition: "Access rights granted by users for features like camera, storage, and location in mobile apps.",
    example: "camera, location, internet"
  },
  {
    term: "Platform Channels",
    category: "Concepts",
    definition: "Mechanism to communicate between Dart/Flutter code and native code (Android/iOS).",
    example: "MethodChannel, EventChannel"
  },
  {
    term: "Play Store / App Store",
    category: "Tools",
    definition: "Official distribution platforms for Android and iOS apps respectively.",
    example: "Publishing, app signing, ratings"
  }
];

const categories = ['All', 'Framework', 'Programming', 'Concepts', 'Data', 'Tools'];
              ...
              <div className="container-fluid">
                <div className="row mb-3 mb-md-4">
                  <div className="col-12">
                    <p className="lead mb-3 mb-md-4 fs-6 fs-md-5">Master the essential vocabulary of Mobile App development</p>
