...
function Achievements() {
  ...
  const projects = [
    ...
    {
      title: "Created a To-Do List App",
      icon: "📝",
      stack: "React, JavaScript, localStorage",
    },
    {
      title: "Developed a Weather Forecast Widget",
      icon: "☀️",
      stack: "JavaScript, APIs, CSS",
    },
    {
      title: "Made a Calculator Application",
      icon: "🧮",
      stack: "JavaScript, HTML, CSS",
    },
    {
      title: "Built a Personal Blog Layout",
      icon: "✍️",
      stack: "HTML, CSS, React",
    },
    {
      title: "Created a Photo Gallery",
      icon: "📸",
      stack: "React, CSS Grid, JavaScript",
    },
    {
      title: "Designed a Login/Signup Form",
      icon: "🔐",
      stack: "React, Formik, Yup, Firebase Auth",
    },
    {
      title: "Developed a Product Landing Page",
      icon: "🛒",
      stack: "HTML, CSS, JavaScript, Bootstrap",
    },
    {
      title: "Implemented Modal/Popup Components",
      icon: "📦",
      stack: "React, CSS, JavaScript",
    },
    {
      title: "Built a Responsive Navigation Bar",
      icon: "🧭",
      stack: "HTML, CSS, JavaScript",
    },
    {
      title: "Created a Countdown Timer",
      icon: "⏰",
    ...
    {
      title: "Built a CSS Animation Showcase",
      icon: "🎞️",
      stack: "CSS, HTML, JavaScript",
    },
    {
      title: "Created a Pricing Table",
      icon: "💲",
      stack: "HTML, CSS, JavaScript",
    },
    {
      title: "Designed a Blog Post Card UI",
      icon: "📰",
    ...
    {
      title: "Created a Social Media Buttons Set",
      icon: "🔗",
      stack: "HTML, CSS, JavaScript",
    },
