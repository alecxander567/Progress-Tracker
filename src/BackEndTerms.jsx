...
function BackEndTerms() {
  ...
  const terms = [
    ...
    },
    {
      ...
      category: "Framework",
      definition:
        "A minimal and flexible Node.js web application framework that provides robust features for building APIs and web servers.",
    ...
    },
    {
      ...
      category: "Programming",
      definition:
        "A general-purpose scripting language especially suited to web development and server-side scripting.",
    ...
    },
    {
      ...
      category: "Framework",
      definition:
        "A PHP web application framework with expressive, elegant syntax for tasks like routing, authentication, and caching.",
    ...
    },
    {
      ...
      category: "Programming",
      definition:
        "A versatile and easy-to-read language widely used for backend development, scripting, and automation.",
    ...
    },
    {
      ...
      category: "Programming",
      definition:
        "A class-based, object-oriented programming language used for building robust back-end systems.",
      example:
    ...
    },
    {
      ...
      category: "Framework",
      definition:
        "A framework that simplifies the bootstrapping and development of Java back-end applications.",
      example:
        "@RestController public class HelloController { @GetMapping('/') String home() { return 'Hello'; }}",
    },
    {
      term: "MySQL",
      category: "Data",
    ...
    },
    {
      ...
      category: "Data",
      definition:
        "An advanced, open-source relational database known for reliability and support for complex queries.",
    ...
    },
    {
      ...
      category: "Concepts",
      definition:
        "JSON Web Tokens - a compact way to securely transmit information between parties as a JSON object.",
    ...
    },
    {
      ...
      category: "Concepts",
      definition:
        "An architectural style for designing networked applications using stateless communication via HTTP.",
    ...
    },
    {
      ...
      category: "Concepts",
      definition:
        "Create, Read, Update, Delete - the basic operations for managing data in a database or API.",
    ...
    },
    {
      ...
      category: "Concepts",
      definition:
        "Object-Relational Mapping - a technique that connects object-oriented code with relational databases.",
    ...
    },
    {
      ...
      category: "Tools",
      definition:
        "An API platform used to build, test, and document APIs quickly and efficiently.",
          ...
          <div className="row mb-3 mb-md-4">
            <div className="col-12">
              <p className="lead mb-3 mb-md-4 fs-6 fs-md-5">
                Master the essential vocabulary of Back-end development
              </p>
