    ...
    >
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        <header className="py-3 d-flex flex-column align-items-center justify-content-center text-center">
          ...
          <div className="container">
            <h1 className="display-4" style={{ fontWeight: "900" }}>
              <span className="text-info">Progress</span> Tracker
            </h1>
            <p className="lead">
              Track your goals and stay motivated every day
            </p>
            <Link
              to="/courses"
          ...
          <div className="container my-5">
            <div className="row justify-content-center">
              <div className="col-md-8">
                <h2>Stay on Track</h2>
                <p>
                  Our app helps you monitor your daily progress, set targets,
                  and keep yourself accountable. Whether it's learning, tech
                  stuffs, Software development or Web Development — we've got
                  you covered.
                </p>
              </div>
            </div>
                ...
                >
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      Choose from a variety of career goals and set your focus
              ...
              <div className="col-md-4 mb-4">
                ...
                >
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      Engage with practical exercises and real-world projects to
                      sharpen your skills.
                    </p>
                  </div>
                </div>
              ...
              <div className="col-md-4 mb-4">
                ...
                >
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      Track progress and build your portfolio step by step as
        ...
        <footer className="py-3 text-center">
          <div className="container">
            <small>
              &copy; {new Date().getFullYear()} Progress Tracker App. All rights
              reserved.
            </small>
          </div>
        </footer>
